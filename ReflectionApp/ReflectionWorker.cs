...
namespace ReflectionApp
{
    internal class ReflectionWorker
    {
        public void Start()
        {
            ...
            AnotherTestClass atc = new AnotherTestClass() { InnerClass = new TestVarClass(30, 30, 30, 30, 'r', false, "anewObject"), SomeDate=DateTime.Today };
    ...
    internal class AnotherTestClass
    {
        ...
        {
            return $"{nameof(InnerClass)}: {InnerClass}, {nameof(SomeDate)}: {SomeDate}";
        }
    }
}